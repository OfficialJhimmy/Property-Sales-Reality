            ...
            <div key={property.id} className="propertydetails__section">
                ...
                <div className="details__info">
                  ...
                  <div className="details__icons">
                    <div className="details__icons--box">
                      ...
                      <BiArea className="details__svg" /> <p>{property.area}</p>
                    </div>
                    <div className="details__icons--box">
              ...
              <div className="property__disclaimer">
                <h2 className="heading-secondary">
                  ...
                  Reality only serves as a medium for the advertisement of this
                  property. PropertySalesReality is only communicating this
                  property offer and is not responsible for selling the
